...
to go to \hyperref[org9e1c6e6]{the next section}, in which we show you how to compile
Attachment Converter into an executable that you can run.

\subsection{Compile Attachment Converter \label{org9e1c6e6}}
\label{sec:org81049d6}
...
\section{During The Workshop \label{org6fc62e0}}
\label{sec:orgf16ba12}
...
please see our \hyperref[orgaf929a8]{pre-workshop installation instructions}.  After the
